...
import type { FriendRequestType, ReceivedFriendRequest, SentFriendRequest } from '#shared/schemas/social'
import { FRIEND_REQUEST_STATUS, FRIEND_REQUEST_TYPE, friendRequestsSchema } from '#shared/schemas/social'

export default defineEventHandler(async (event): Promise<SentFriendRequest[] | ReceivedFriendRequest[]> => {
...
async function findFriendRequests(userId: string, type: FriendRequestType): Promise<SentFriendRequest[] | ReceivedFriendRequest[]> {
